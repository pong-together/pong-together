...
export default class extends Component {
	...
	connectSocket() {
		...
		socket.onopen = () => {
			...
			document.querySelector('#chat-form').addEventListener('submit', (e) => {
				...
				if (socket.readyState === WebSocket.OPEN) {
					socket.send(document.querySelector('#m').value);
		...
		socket.onclose = () => {
			...
			setTimeout(() => this.connectSocket(), 5000); // Try to reconnect every 5 seconds
		};
	...
	mounted() {
		window.removeEventListener('hashchange', this.changeModule.bind(this));
		window.removeEventListener('load', this.changeModule.bind(this));
		window.addEventListener('hashchange', this.changeModule.bind(this));
		window.addEventListener('load', this.changeModule.bind(this));
		this.changeModule();
		this.routerModule();
		this.connectSocket();
	}
